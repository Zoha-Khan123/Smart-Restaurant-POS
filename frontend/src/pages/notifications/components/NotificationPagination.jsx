...
export default function NotificationPagination({
  ...
  return (
    <div className="p-4 rounded-2xl bg-bg-card border border-border flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <span className="text-text-muted">
          ...
          <strong className="text-text-primary">{totalItems}</strong> notifications
        </span>
